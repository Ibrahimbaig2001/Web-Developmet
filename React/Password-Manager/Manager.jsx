...
const Manager = () => {
    ...
    useEffect(() => {
        ...
        // Guard against null, undefined string, empty string
        ...
        try {
            ...
            setPasswordArray([])
            localStorage.removeItem("passwords") // self-heal
        }
    }, [])
    useEffect(() => {
  ...
  toast('Password Saved Successfully', {
        ...
        toast('Please fill all fields with more than 3 characters', {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: false,
    ...
    const editPassword = (id) =>{
        ...
        setPasswordArray(passwordArray.filter(item => item.id !== id))
        toast('Edited and Saved Successfully', {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: false,
